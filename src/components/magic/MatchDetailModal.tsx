...
import { X, Trophy, PlusCircle, Tv, TrendingUp, Star, CheckCircle2, Brain, Activity, Swords, Users, Info, BarChart3, LineChart } from "lucide-react";
    ...
    <AnimatePresence>
      {match && (
        ...
        >
          ...
          {/* Header fixe */}
          <div className="relative p-5 border-b border-border/60 flex-none bg-background/60 backdrop-blur-md z-20">
            <button
              onClick={onClose}
            ...
            <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-2 text-center">
              <p className="text-[11px] font-display font-black text-foreground uppercase break-words leading-tight">
                {match.homeTeam}
              </p>
              <div className="text-xl font-display font-black holo-text">VS</div>
              <p className="text-[11px] font-display font-black text-foreground uppercase break-words leading-tight">
                {match.awayTeam}
              </p>
            </div>
          ...
          <div className="p-5 overflow-y-auto flex-1 space-y-6 pb-12 overscroll-contain relative z-10">
            ...
            {(() => {
              ...
              return (
                <div className="relative pt-2 z-10">
                  <div className="relative mx-auto max-w-md p-3">
                    {/* Logos + Info match */}
                    <MatchHeroFx
